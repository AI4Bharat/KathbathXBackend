...
// Participant Registration Router
export const workerRegistrationRouter = new Router<KaryaDefaultState>();
workerRegistrationRouter.post('/worker/create', BodyParser(), WorkerController.createNewWorker);
